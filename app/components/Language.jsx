        ...
        <div id={`language${props.language.id}`}
            ...
            <div className="flex items-center w-full justify-start gap-5">
                ...
                <div className="flex flex-wrap w-full justify-between items-center gap-2">
                    <h3 className="sm:text-2xl flex-20 text-xl">{props.language.name}</h3>
                    <p className="bg-primary  grow text-center sm:text-base text-xs text-secondary py-2 px-4 rounded-4xl">{props.language.proficiency}</p>
                </div>
            </div>
        </div>
    );
